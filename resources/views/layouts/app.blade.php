                ...
                <div class="row">
                    <ul class="navbar-nav ms-auto d-inline-flex flex-row text-lg-right justify-content-end align-middle">
                        {{-- <div class="d-inline-flex align-items-center">
                            <p><a href="login" class="topbar-text mr-2">Log In</a></p>
                            <p class="text-body px-3">|</p>
                            <p><a href="register" class="topbar-text mr-2">Register</a></p>
                            <p class="text-body px-3">|</p>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            @if(auth()->check())
                            <a href="/ordered" class="nav-item nav-link">Ordered Packages</a>
                            @if(auth()->user()->id == 1)
                            <a href="/users" class="nav-item nav-link">Users</a>
                            @endif
                            @endif
                            <div class="nav-item dropdown">
                                <a href="#packages" class="nav-link dropdown-toggle" data-toggle="dropdown">Packages</a>
